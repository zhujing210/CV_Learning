...
img_norm_cfg = dict(mean=[0.3676692, 0.38692534, 0.37536806], std=[0.3676692, 0.38692534, 0.37536806], to_rgb=True)
train_pipeline = [
...
#load_from = '/home/hongbin/Downloads/mmdetection/Checkpoints/yolov3_d53_mstrain-608_273e_coco-139f5633.pth'
