...
if __name__ == '__main__':
    ...
    data_transforms = {
        ...
        [
            # Resize()里面若要指定H、W，一定要用数组框起来，不要直接Resize(224, 224)，不然报错无法转为tensor类型，白白调试了几个小时！！
    ...
    image_datasets = {x: customData(img_path=('E:/data/data/' + x + '/'),
                                    txt_path=('E:/data/data/' + x + '/' + x + '.txt'),
                                    dataset=x,
